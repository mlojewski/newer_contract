                ...
                <div class="row">
                    <div class="col-md-6 col-lg-12">
                        <div class="product-widget">
                            <h6 class="product-widget-title">Filter by gender</h6>
                            <form class="product-widget-form" action="{{route('person.filter')}}">
                                @foreach($genders as $gender)
                                    <li class="product-widget-item">
                                        <input type="radio" id={{$gender->id}} name="gender" value={{$gender->id}} >
                                        <label for={{$gender->id}}>{{$gender->name}}</label><br>
                                    </li>
                                @endforeach
...
{{--                                </div>--}}
                                <div class="product-type">
                                    <span class="flat-badge booking">{{$person->sport->name}}</span>
                                </div>
...
{{--                                </ul>--}}
                            ...
                            <div class="product-content">
                                <ol class="breadcrumb product-category">
                                    ...
                                    <li class="breadcrumb-item">{{$person->personType->name}}</li>

                                </ol>
                                <h5 class="product-title">
                                    <a href={{route('user.show', ['id' => $person->user->id])}}>{{$person->name}} {{$person->last_name}}</a>
                                </h5>
                                <div class="product-meta">
                                    <span class="product-price">{{$person->gender->name}}</span>
                                </div>
                                <div class="product-info">
                                    <span><i class="fas fa-map-marker-alt"></i> {{$person->country->name}}</span>
                                    <span><i class="fas fa-clock"></i> {{$person->birth_date}}</span>
